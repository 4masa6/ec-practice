    ...
    <div class="d-flex justify-content-center">
        <div class="row w-75">
            ...
            <div class="offset-1 col-10">
                <div class="row">
                    <!--todo:コントローラーから渡したreviewsをforeachで１つずつ表示している-->
                ...
                @auth <!--todo:ログイン済であれば表示-->
                    <div class="row">
                        <div class="offset-md-5 col-md-5">
                            <form method="POST" action="/products/{{ $product->id }}/reviews"> <!--todo:レビューを作成するルーティングへPOST-->
                                {{ csrf_field() }}
                                <h4>評価</h4>
